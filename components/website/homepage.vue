...
<template>
  <div
    class="tw-min-h-screen tw-flex tw-flex-col tw-gap-4 tw-items-center tw-justify-center"
  >
    <n-space>
    ...
    <div
      v-if="isLoading"
      class="tw-w-[300px] tw-h-[200px] tw-animate-pulse tw-bg-gray-500/5 tw-p-2"
    >
      Loading...
    </div>
